...
class Ui_GraphWindow(object):
    def setupUi(self, GraphWindow):
        ...
        self.label_3.setGeometry(QtCore.QRect(680, 170, 221, 16))
        font = QtGui.QFont()
        font.setPointSize(10)
        ...
        self.formLayoutWidget_2.setGeometry(QtCore.QRect(600, 210, 341, 171))
    ...
    def retranslateUi(self, GraphWindow):
        ...
        self.label_unr_mu_w.setText(_translate("GraphWindow", "М.о. длительности пребывания требований в очереди от нтенсивности обслуживания требования одним прибором"))
        ...
        self.label_r_mu_w.setText(_translate("GraphWindow", "М.о. длительности пребывания требований в очереди от нтенсивности обслуживания требования одним прибором"))
